  ...
  try {
    ...
    resultsBox.innerHTML = payload.results.map((result) => {
      ...
      return `<article class="result">
        ...
        <div class="images"><figure><img src="${result.image_url}" alt="${escapeHtml(result.property_name)}"><figcaption>Final 400 × 200</figcaption></figure><figure><img src="${result.master_image_url}" alt="${escapeHtml(result.property_name)} master"><figcaption>Master 1600 × 800</figcaption></figure></div>
